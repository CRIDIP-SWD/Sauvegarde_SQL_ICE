...
-- Généré le :  Jeu 14 Mai 2015 à 19:11
...
(214, '1426114800', 'VERSEMENT ENTREPRISE ', 35, '', '4075'),
...
--
ALTER TABLE `compta_compte`
MODIFY `idcomptacompte` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=483;
--
...
--
ALTER TABLE `compta_mvm`
MODIFY `idcomptamvm` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=226;
--
...
--
ALTER TABLE `compta_resultat`
MODIFY `idresultat` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=226;
--
