...
(48, 2, 'Vente de la prestation: SAUCISSON A L''AIL pour fresneau eric.', '', '70', ''),
(49, 2, 'Vente de la prestation: SAUCISSON D''ARDECHE pour fresneau eric.', '', '56', ''),
(50, 2, 'Vente de la prestation: SAUCISSON D''ARDECHE pour fresneau eric.', '', '105', ''),
(51, 2, 'Vente de la prestation: SAUCISSON A L''AIL pour fresneau eric.', '', '10', '');
...
(21, 68, '01-01-2015', 3, '70', 1),
(22, 68, '11-02-2015', 3, '56', 1),
(23, 68, '19-02-2015', 3, '105', 1),
(24, 68, '20-02-2015', 3, '10', 1);
...
(48, '', '01-01-2015', 'Vente de la prestation: SAUCISSON A L''AIL pour fresneau eric.', '', '70'),
(49, '', '11-02-2015', 'Vente de la prestation: SAUCISSON D''ARDECHE pour fresneau eric.', '', '56'),
(50, '', '19-02-2015', 'Vente de la prestation: SAUCISSON D''ARDECHE pour fresneau eric.', '', '105'),
(51, '', '20-02-2015', 'Vente de la prestation: SAUCISSON A L''AIL pour fresneau eric.', '', '10');
...
(62, 44, 'SAUCISSON A L''AIL', '01-01-2015', '31-12-2015', '10', '0', '10', '1000', '10', 0),
(63, 44, 'SAUCISSON D''ARDECHE', '01-01-2015', '31-12-2015', '7', '0', '7', '1000', '5', 0);
...
(6, '10/02/2015', 2, 'gfgfgfgfgf123', '126', 1),
(8, '01/03/2015', 1, 'kjkjkjkjkj', '115', 1);
...
(22, '01-01-2015', '', 'Reglement Client', 'EspÃ¨ce', 'Reglement de la prestation par EspÃ¨ce.', '', '70', 1),
(24, '11-02-2015', '', 'Reglement Client', 'EspÃ¨ce', 'Reglement de la prestation par EspÃ¨ce.', '', '56', 1),
(25, '10/02/2015', 'gfgfgfgfgf123', 'Remise Bancaire', 'Remise de EspÃ¨ce', 'Remise en banque NÂ° gfgfgfgfgf123 en date du 10/02/2015.', '126', '', 1),
(26, '19-02-2015', '', 'Reglement Client', 'ChÃ¨que', 'Reglement de la prestation par chÃ¨que au nom de .', '', '105', 0),
(27, '20-02-2015', '', 'Reglement Client', 'ChÃ¨que', 'Reglement de la prestation par chÃ¨que au nom de .', '', '10', 0),
(28, '01/03/2015', 'kjkjkjkjkj', 'Remise Bancaire', 'Remise de ChÃ¨que', 'Remise en banque NÂ° kjkjkjkjkj en date du 01/03/2015.', '115', '', 1);
...
--
ALTER TABLE `ayant_droit`
MODIFY `idayantdroit` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=79;
--
-- AUTO_INCREMENT pour la table `bilan`
--
ALTER TABLE `bilan`
MODIFY `idcasebilan` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=52;
--
...
--
ALTER TABLE `compta_compte`
MODIFY `idcomptacompte` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `cpt_resultat`
MODIFY `idcptresultat` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=52;
--
...
--
ALTER TABLE `remb_salarie`
MODIFY `idrembsalarie` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
