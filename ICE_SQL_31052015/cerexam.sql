...
(58, 64, 'ALLAMAN', 'ANDERSON', '09/01/2002', '296.54'),
...
(140, 153, 'GONCALVES NEIVA', 'MAEVA', '25/03/2002', '131.75'),
...
(155, 171, 'LACARRIEU-HAURAT', 'MORGANE', '05/10/1999', '40.535'),
...
(176, 208, 'MOUSQUES DIT CABANOT', 'VALENTINE', '10/04/2007', '262.55'),
(177, 208, 'MOUSQUES DIT CABANOT', 'JEAN ', '30/01/2004', '270.05'),
...
(185, 216, 'NOUSTY', 'EMMA', '24/10/2009', '270.875'),
...
(189, 223, 'PERALTA', 'ANTONIN', '17/03/2005', '271.25'),
...
(432, 1, 'Ajout de la charge Fixe: Achat Ch&egrave;ques vacances ANCV N&deg; 0000484', '57424.60', '', ''),
(433, 1, 'Remboursement de la prestation: centre aere + paje emploi pour DATHY MAXIME', '418.6875', '', ''),
(434, 1, 'Remboursement de la prestation: centre aere + paje emploi pour DATHY JUSTINE', '424.23', '', ''),
...
(452, 1, 'Ajout de la charge Fixe: CIRQUE DE NOEL', '1260', '', '');
...
(6, 'Achat Ch&egrave;ques vacances ANCV N&deg; 0000484', '12-05-2015', '57424.60'),
(7, 'CIRQUE DE NOEL', '30-05-2015', '1260');
...
(432, '', '1431381600', 'Achat Ch&egrave;ques vacances ANCV N&deg; 0000484', '57424.60', ''),
(433, '', '1432159200', 'Remboursement de la Prestation pour DATHY MAXIME - centre aere + paje emploi', '418.6875', ''),
(434, '', '1432159200', 'Remboursement de la Prestation pour DATHY JUSTINE - centre aere + paje emploi', '424.23', ''),
...
(452, '', '1432936800', 'CIRQUE DE NOEL', '1260', '');
...
(6, 49, 'PLACE AU CIRQUE', '30-05-2015', '31-12-2015', '0', '14', '14', '', '90', 0);
...
(61, '00010005', 1, 'ALBANEL', 'HERVE', 'C R n?5', 'Cami de Pipaoutou', '64230', 'MOMAS', '05 59 33 87 48', '', '', '27/01/1969', '', '', '', 'r̩gleur', '215  E', '', 'CDI', 1, '59.5'),
...
(65, '00010008', 1, 'ALVES ', 'PAUL', '158 Route du Bourg', '', '40700', 'MOMUY', '', '06 88 64 25 63', '', '05/08/1966', '', '', '', 'controleur', '215 A', '', 'CDI', 1, '185'),
...
(69, '00010013', 1, 'BALLESTEROS ', 'DIDIER', 'chemin de Bouhaben', 'Quartier Loupien', '64360', 'MONEIN', '05 59 21 43 88', '', '', '26/02/1964', '', '', '', 'Controleur', '190 F', '', 'CDI', 1, '44.5'),
...
(138, '00010074', 1, 'DULAU ', 'EMMANUEL', '238, chemin d''Arrignan', '', '64300', 'SAINT GIRONS EN BEARN', '05 59 67 94 60', '', '', '12/12/1969', '', '', '', 'Op̩rateur', '190 A', '', 'CDI', 1, '165.375'),
...
(144, '00010083', 1, 'ETCHEVERRY', 'JACQUES', '3, rue de l''Aygue-Longue', '', '64121', 'SERRES-CASTET', '05 59 33 11 40', '', '', '21/03/1954', '', '', '', 'Op̩rateur', '215 D', '', 'CDI', 1, '126'),
...
(171, '00010109', 1, 'LACARRIEU-HAURAT ', 'JEAN PIERRE', '3, rue Lagrange', '', '64150', 'MOURENX', '05 59 60 21 34', '', '', '16/03/1973', '', '', '', 'Op̩rateur', '215 C', '', 'CDI', 1, '21.55'),
...
(184, '00010127', 1, 'LOPEZ  ', 'OLIVIER', '1, rue de Lannes', '', '64150', 'MOURENX', '', '06 73 03 54 24', '', '06/09/1986', '', '', '', 'Automaticien', '240 C', '', 'CDI', 1, '87.5'),
...
--
ALTER TABLE `bilan`
MODIFY `idcasebilan` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=453;
--
...
--
ALTER TABLE `charge_fixe`
MODIFY `idchargefixe` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `cpt_resultat`
MODIFY `idcptresultat` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=453;
--
-- AUTO_INCREMENT pour la table `famille_prestation`
--
ALTER TABLE `famille_prestation`
MODIFY `idfamilleprestation` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=50;
--
...
--
ALTER TABLE `reg_remb_ayant_droit`
MODIFY `idregrembayantdroit` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=131;
--
-- AUTO_INCREMENT pour la table `reg_remb_salarie`
--
ALTER TABLE `reg_remb_salarie`
MODIFY `idregrembsalarie` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=137;
--
-- AUTO_INCREMENT pour la table `remb_ayant_droit`
--
ALTER TABLE `remb_ayant_droit`
MODIFY `idrembayantdroit` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=136;
--
-- AUTO_INCREMENT pour la table `remb_salarie`
--
ALTER TABLE `remb_salarie`
MODIFY `idrembsalarie` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=146;
--
