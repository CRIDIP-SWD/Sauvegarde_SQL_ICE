...
(1, '06-05-2015', 63, '50', '330'),
(2, '14-05-2015', 64, '64', '12800'),
(3, '21-05-2015', 65, '50', '1000');
...
(1, 69, 'AGOSTINHO', 'KEVIN', '01-01-2015', '999999999999999999'),
(2, 69, 'DUPONT', 'JEN', '03-09-2013', '999999999999999999');
...
(32, 1, 'Achat: CINEVILLE SAINT GILLES CROIX DE VIE', '330', '', ''),
(33, 2, 'Vente de Billetterie: AGOSTINHO alexandre pour la prestation CINEVILLE SAINT GILLES CROIX DE VIE', '', '9.2', '90333027'),
(34, 2, 'Vente de Billetterie: THOMAS D pour la prestation CINEVILLE SAINT GILLES CROIX DE VIE', '', '18.4', '95709217'),
(35, 2, 'Ajout du produit fixe: ANCV MAI 2015', '', '1292', '9702973850'),
(36, 1, 'Achat: CHEQUES ANCV 2015', '12800', '', ''),
(37, 2, 'Vente de Billetterie: AGOSTINHO alexandre pour la prestation CHEQUES ANCV 2015', '', '0', '73968176'),
(39, 2, 'Vente de Billetterie: AGOSTINHO alexandre pour la prestation CINEVILLE SAINT GILLES CROIX DE VIE', '', '13.8', '84786579'),
(40, 1, 'Achat: BON ACHAT ENFANTS', '1000', '', ''),
(41, 2, 'Vente de Billetterie: DUPONT JEN pour la prestation BON ACHAT ENFANTS', '', '0', '47495608');
...
(16, 69, '22-05-2015', 3, '9.2', 1, '90333027'),
(18, 68, '05-05-2015', 2, '18.4', 1, '95709217'),
(19, 69, '21-05-2015', 3, '0', 1, '73968176'),
(21, 69, '05-05-2015', 3, '13.8', 1, '84786579');
...
(32, '', '1430863200', 'Achat - CINEVILLE SAINT GILLES CROIX DE VIE', '330', ''),
(33, '90333027', '1432245600', 'Vente de Billetterie: AGOSTINHO alexandre pour la prestation CINEVILLE SAINT GILLES CROIX DE VIE', '', '9.2'),
(34, '95709217', '1430776800', 'Vente de Billetterie: THOMAS D pour la prestation CINEVILLE SAINT GILLES CROIX DE VIE', '', '18.4'),
(35, '9702973850', '1431640800', 'ANCV MAI 2015', '', '1292'),
(36, '', '1431554400', 'Achat - CHEQUES ANCV 2015', '12800', ''),
(37, '73968176', '1432159200', 'Vente de Billetterie: AGOSTINHO alexandre pour la prestation CHEQUES ANCV 2015', '', '0'),
(39, '84786579', '1430776800', 'Vente de Billetterie: AGOSTINHO alexandre pour la prestation CINEVILLE SAINT GILLES CROIX DE VIE', '', '13.8'),
(40, '', '1432159200', 'Achat - BON ACHAT ENFANTS', '1000', ''),
(41, '47495608', '1450998000', 'Vente de Billetterie: DUPONT JEN pour la prestation BON ACHAT ENFANTS', '', '0');
...
(63, 46, 'CINEVILLE SAINT GILLES CROIX DE VIE', '01-05-2015', '25-09-2015', '4.60', '2.00', '6.6', '5', '41', 0),
...
(1, 'ANCV MAI 2015', '15-05-2015', '1292', '9702973850');
...
(1, 16, 1, '9.2', 'BPA', 'AGOSTIHO', '4561', 1),
(2, 18, 1, '18.4', 'SG', 'THOMAS', '1234', 1),
(3, 19, 3, '0', '', '', '224198310', 0),
(5, 21, 1, '13.8', 'LCL', 'AGOSTINHO', '4562', 0);
...
(1, '24-05-2015', 1, 'DF456njh45656', '27.6', 1);
...
(1, '1432245600', '4561', 'Reglement Client', 'ChÃ¨que', 'Reglement de la prestation par chÃ¨que au nom de AGOSTIHO.', '', '9.2', 0),
(2, '1430776800', '1234', 'Reglement Client', 'ChÃ¨que', 'Reglement de la prestation par chÃ¨que au nom de THOMAS.', '', '18.4', 0),
(3, '1432418400', 'DF456njh45656', 'Remise Bancaire', 'Remise de ChÃ¨que', 'Remise en banque NÂ° DF456njh45656 en date du 24-05-2015.', '27.6', '', 1),
(4, '1432159200', '224198310', 'Reglement Client', 'EspÃ¨ce', 'Reglement de la prestation en espÃ¨ce par .', '', '0', 0),
(6, '1430776800', '4562', 'Reglement Client', 'ChÃ¨que', 'Reglement de la prestation par chÃ¨que au nom de AGOSTINHO.', '', '13.8', 0),
(7, '1450998000', '448582805', 'Reglement Client', 'EspÃ¨ce', 'Reglement de la prestation en espÃ¨ce par .', '', '0', 0);
...
--
ALTER TABLE `ayant_droit`
MODIFY `idayantdroit` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `compta_banque`
MODIFY `idcomptabanque` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `compta_compte`
MODIFY `idcomptacompte` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `compta_mvm`
MODIFY `idcomptamvm` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `compta_resultat`
MODIFY `idresultat` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `salarie`
MODIFY `idsalarie` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=70;
--
-- AUTO_INCREMENT pour la table `solde_caisse`
--
ALTER TABLE `solde_caisse`
MODIFY `idsoldecaisse` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
