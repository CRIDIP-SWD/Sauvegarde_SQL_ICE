...
(87, 727, 'MOCKELYN', 'Louis', '12-06-2014', '90');
...
(1, '1420153200', 'DARTY ECRAN ORDI CHQ 1234', 3, '', '500'),
(2, '1432072800', 'SUBVENTION FCT VIREMENT INTERNE', 3, '8000', ''),
(3, '1431208800', 'TISSOT REVUE CHQ 1235', 3, '', '100'),
(5, '', '', 0, '', '5.60');
...
(1, '1420153200', 'DARTY ECRAN ORDINATEUR CHQ 1234', 60, '500', ''),
(2, '1428616800', 'SUBVENTION FCT VIREMENT INTERNE', 35, '', '8000'),
(3, '1431208800', 'TISSOT REVUE CHQ 1235', 55, '100', ''),
(4, '1431640800', 'LA POSTE TIMBRES CHS 4568', 50, '5.60', '');
...
(1, 'COMITE DEMO PREMIUM', '0.50', '0.25', 'FACTA000', 'FACVE000', 'F1A6E-62E69-1D508-10E25-1308B', '', '');
...
(85, 51, 'PARC ASTERIX ADULTE', '01-01-2015', '31-12-2015', '20', '15', '35', '5', '95', 0),
(86, 51, 'PARC ASTERIX ENFANT', '01-01-2015', '31-12-2015', '15', '10', '25', '5', '99', 0),
(88, 53, 'PISCINE LE REMBLAI', '01-01-2015', '31-12-2020', '3', '1', '4', '10', '80', 0);
...
(726, '0211452', 1, 'THOMAS', 'Dominique', '', '', '', '', '', '', '', '', '', '', '1', '', '', '', '', 1, '0'),
(727, '024457', 1, 'Mockelyn', 'Maxime', '20 Avenue Jean jaures', '20 Avenue Jean jaures', '85100', 'Les Sables d''Olonne', '0251232424', '33633134330', 'mmockelyn@gmail.com', '21-07-1992', '17-06-2010', '', '1', 'Comptabilite', '125', '', 'CDI', 1, '0.050000000000011');
...
--
ALTER TABLE `ayant_droit`
MODIFY `idayantdroit` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=88;
--
-- AUTO_INCREMENT pour la table `bilan`
--
ALTER TABLE `bilan`
MODIFY `idcasebilan` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=44;
--
...
--
ALTER TABLE `billet_salarie`
MODIFY `idbilletsalarie` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `compta_mvm`
MODIFY `idcomptamvm` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `compta_resultat`
MODIFY `idresultat` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `cpt_resultat`
MODIFY `idcptresultat` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=44;
--
-- AUTO_INCREMENT pour la table `famille_prestation`
--
ALTER TABLE `famille_prestation`
MODIFY `idfamilleprestation` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=54;
--
-- AUTO_INCREMENT pour la table `ligne_billet_ayant_droit`
--
ALTER TABLE `ligne_billet_ayant_droit`
MODIFY `idlignebilletayantdroit` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT pour la table `ligne_billet_salarie`
--
ALTER TABLE `ligne_billet_salarie`
MODIFY `idlignebilletsalarie` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `produit_fixe`
MODIFY `idproduitfixe` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT pour la table `reg_billet_ayant_droit`
--
ALTER TABLE `reg_billet_ayant_droit`
MODIFY `idregbilletayantdroit` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `reg_remb_salarie`
MODIFY `idregrembsalarie` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `remb_salarie`
MODIFY `idrembsalarie` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT pour la table `remise_banque`
--
ALTER TABLE `remise_banque`
MODIFY `idremisebanque` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
...
--
ALTER TABLE `remise_banque_esp`
MODIFY `idremisebanqueesp` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT pour la table `salarie`
--
ALTER TABLE `salarie`
MODIFY `idsalarie` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=728;
--
-- AUTO_INCREMENT pour la table `solde_caisse`
--
ALTER TABLE `solde_caisse`
MODIFY `idsoldecaisse` int(13) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=29;
